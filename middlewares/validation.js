...
//
const EXCLUDE = ['/register/client', '/login/client', '/register/dispatcher', '/login/dispatcher','/register/driver', '/login/driver', '/login/admin', '/drivers/make-call', '/drivers/verify', '/clients/make-call', '/clients/register']
